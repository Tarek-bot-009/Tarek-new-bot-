...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস কাকে থাপ্পড়াতে চান তাকে @ম্যানশন করুন", event.threadID);
...
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খাংকির মেয়ে 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "তর আম্মু রে আচার এর লোভ দেখিয়ে চুদি মাগির মেয়ে🤬" + " " + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "বান্দির মেয়ে তর কচি বোনের ভুদা ফাক কর থুথু দিয়ে ভুদায় দন ডুকামু 🤟" + " " + name, mentions: arraytag})}, 20000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির মেয়ে এমন চুদা দিমু লাইফ টাইম মনে রাখভি তারেক তর বাপ মাগির মেয়ে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "DNA টেষ্ট করিয়ে দেখবি আমার চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a({body: "Hi তারেক এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "উম্মম্মা তর বোন এর কচি ভুদায়💉।" + " " + name, mentions: arraytag})}, 150000);
...
setTimeout(() => {a({body: "Hi তারেক এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "কুত্তার বাচ্ছা তর বোন ভোদায় মাগুর মাছ চাষ করুম।😍.." + " " + name, mentions: arraytag})}, 5000);
